...
#include "./mavlink_msg_bind_flyer_plane.h"
#include "./mavlink_msg_bind_flyer_plane_ack.h"
#include "./mavlink_msg_vehicle_control.h"
#include "./mavlink_msg_vehicle_info.h"
