 ...
 * test finishes successfully. Note that this doesn?? take effect until
 * g_test_run() is called, so calls to (for example) g_get_user_home_dir() will
 * return the system-wide value when made in a test program?? main() function.
 *
 ...
 * to create the directory if it doesn?? exist.
 *
 * Since: 2.60
 */
