...
public:
    ...
    Q_PROPERTY(Fact*            altOffset                   READ altOffset                                          CONSTANT)
    /// Optional sections
    ...
    Fact* altOffset                     (void) { return &_altOffsetFact; }
    ...
    static const char* altOffsetName;
...
protected:
    ...
    void    _appendSpeedSectionItems        (QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum);
...
private:
    ...
    bool _addedSpeedSection = false;
    double _distanceToSurfaceNoAltOffset;
};
