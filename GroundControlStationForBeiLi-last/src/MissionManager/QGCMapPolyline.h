...
public:
    ...
    Q_PROPERTY(double               length      READ length                                 NOTIFY pathChanged)
    ...
    Q_INVOKABLE void saveKMLToFile(const QString& kmlFile);
    ...
    QDomElement kmlPolylineElement(KMLDomDocument& domDocument);

    /// Returns the length of the polyline in meters
    double length(void) const;

    Q_INVOKABLE QGeoCoordinate center() { return _center; }
