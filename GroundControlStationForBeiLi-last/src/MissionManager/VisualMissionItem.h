...
public:
    ...
    Q_PROPERTY(bool             specifiedCarAndPlane                READ specifiedCarAndPlane                                               NOTIFY specifiedCarAndPlaneChanged)                 ///< NaN for not specified
    ...
    virtual bool            specifiedCarAndPlane    (void) { return false; }
    ...
    virtual QString mapVisualQML(void) const = 0; // 在地图中显示的航点
...
signals:
    ...
    void specifiedCarAndPlaneChanged    (void);
