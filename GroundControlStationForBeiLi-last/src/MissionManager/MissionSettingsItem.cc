    ...
    , _carSection                       (masterController)
{
    ...
    connect(&_carSection,       &CarSection::itemCountChanged,                          this, &MissionSettingsItem::_setDirtyAndUpdateLastSequenceNumber);
    ...
    connect(&_carSection,       &CarSection::dirtyChanged,                              this, &MissionSettingsItem::_sectionDirtyChanged);
    ...
    connect(&_carSection,       &CarSection::specifiedCarAndPlaneChanged,               this, &MissionSettingsItem::specifiedFlightSpeedChanged);
...
int MissionSettingsItem::lastSequenceNumber(void) const
{
    ...
    lastSequenceNumber += _carSection.itemCount();
...
bool MissionSettingsItem::scanForMissionSettings(QmlObjectListModel* visualItems, int scanIndex)
{
    ...
    foundSpeedSection = _carSection.scanForSection(visualItems, scanIndex);
...
bool MissionSettingsItem::specifiedCarAndPlane()
{
