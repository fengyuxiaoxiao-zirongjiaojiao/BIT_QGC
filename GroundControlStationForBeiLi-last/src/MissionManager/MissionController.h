...
public:
    ...
    Q_PROPERTY(QmlObjectListModel*  dottedFlightPathSegments        READ dottedFlightPathSegments       CONSTANT)
    ...
    Q_INVOKABLE int takeoffCommand(void);

    Q_INVOKABLE int landCommand(void);

    Q_INVOKABLE void distanceMapPoint(const QGeoCoordinate coord1, const QGeoCoordinate coord2);
    ...
    QmlObjectListModel* dottedFlightPathSegments    (void) { return &_dottedFlightPathSegments; }
    ...
    QList<MissionItem *> missionItems(void);
signals:
...
private slots:
    ...
    void _recalcDottedFlightPathSegments        (void);
...
private:
    ...
    QmlObjectListModel          _dottedFlightPathSegments;
