...
public:
    ...
    Q_PROPERTY(QObject*         carSection              READ carSection                                         NOTIFY carSectionChanged)
    ...
    CarSection*     carSection          (void) { return _carSection; }
    ...
    bool            specifiedCarAndPlane        (void) override;
...
signals:
    ...
    void carSectionChanged          (QObject* carSection);
...
private:
    ...
    CarSection*     _carSection =               nullptr;
