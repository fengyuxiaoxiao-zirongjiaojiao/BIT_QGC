...
public:
    ...
    Q_PROPERTY(Fact*            valueSetIsFrontalOverlap    READ valueSetIsFrontalOverlap                                       CONSTANT)
    Q_PROPERTY(Fact*            valueSetIsSideOverlap       READ valueSetIsSideOverlap                                          CONSTANT)
    ...
    Fact* valueSetIsFrontalOverlap  (void) { return &_valueSetIsFrontalOverlapFact; }
    Fact* valueSetIsSideOverlap     (void) { return &_valueSetIsSideOverlapFact; }
    ...
    const Fact* valueSetIsFrontalOverlap    (void) const { return &_valueSetIsFrontalOverlapFact; }
    const Fact* valueSetIsSideOverlap       (void) const { return &_valueSetIsSideOverlapFact; }
    ...
    static const char* valueSetIsFrontalOverlapName;
    static const char* valueSetIsSideOverlapName;
...
private:
    ...
    QmlObjectListModel *_knownCameraList;
    ...
    SettingsFact _valueSetIsFrontalOverlapFact;
    SettingsFact _valueSetIsSideOverlapFact;
