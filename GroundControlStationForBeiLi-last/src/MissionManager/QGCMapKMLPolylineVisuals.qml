...
Item {
    ...
    property bool   polylineTraceMode
    ...
    QGCMenu {
        ...
        QGCMenuItem {
            id:             removeAllVertexItem
            text:           qsTr("Remove all vertex" )
            onTriggered:    mapPolyline.clear()
        }
    ...
    QGCFileDialog {
        ...
        onAcceptedForSave: {
            if (!planFiles) {
                mapPolyline.saveKMLToFile(file)
            }
            close()
        }
