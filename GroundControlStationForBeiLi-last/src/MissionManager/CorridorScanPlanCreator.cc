...
void CorridorScanPlanCreator::createPlan(const QGeoCoordinate& mapCenterCoord)
{
    ...
    _missionController->insertComplexMissionItem(CorridorScanComplexItem::name, mapCenterCoord, -1)->setWizardMode(false);;
    _missionController->insertLandItem(mapCenterCoord, -1)->setWizardMode(false);;
