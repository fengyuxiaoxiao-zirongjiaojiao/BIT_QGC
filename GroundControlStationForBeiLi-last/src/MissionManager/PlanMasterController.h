...
public:
    ...
    static void sendPlanToVehicle(Vehicle* vehicle, const QJsonDocument& jsonDoc);

    Q_INVOKABLE void loadFromVehicle(void);
    Q_INVOKABLE void sendToVehicle(void);
    Q_INVOKABLE void sendToVehicles();
    Q_INVOKABLE void loadFromFile(const QString& filename);
    Q_INVOKABLE void saveToCurrent();
    Q_INVOKABLE void saveToFile(const QString& filename);
    Q_INVOKABLE void saveToKml(const QString& filename);
    Q_INVOKABLE void saveToWaypoints(const QString& filename);
    ...
    Q_INVOKABLE void setSelectedVehicleIds(const QStringList &ids);
    ...
    static PlanMasterController* _instance;
    static PlanMasterController* getInstance() {
        return _instance;
    }

    double NAN_TO_0(double v) {
        if (qIsNaN(v)) return 0.0;
        else return v;
    }
signals:
