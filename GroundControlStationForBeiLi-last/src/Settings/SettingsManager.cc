...
#endif
    , _vehicleInfoSettings          (nullptr)
    , _cameraInfoSettings           (nullptr)
    , _httpServerSettings            (nullptr)
    , _rosTopicSettings             (nullptr)
{
...
#endif
    _cameraInfoSettings =           new CameraInfoSettings          (this);
    _vehicleInfoSettings =          new VehicleInfoSettings         (this);
    _httpServerSettings =           new HttpServerSettings          (this);
    _ntripSettings =                new NTRIPSettings               (this);
    _rosTopicSettings =             new RosTopicSettings            (this);
}
