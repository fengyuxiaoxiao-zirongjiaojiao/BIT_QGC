...
#endif
    Q_PROPERTY(QObject* vehicleInfoSettings             READ vehicleInfoSettings            CONSTANT)
    Q_PROPERTY(QObject* cameraInfoSettings              READ cameraInfoSettings             CONSTANT)
    Q_PROPERTY(QObject* httpServerSettings              READ httpServerSettings             CONSTANT)
    Q_PROPERTY(QObject* ntripSettings                   READ ntripSettings                  CONSTANT)
    Q_PROPERTY(QObject* rosTopicSettings                READ rosTopicSettings               CONSTANT)
...
#endif
    VehicleInfoSettings*            vehicleInfoSettings         (void) { return _vehicleInfoSettings; }
    CameraInfoSettings*             cameraInfoSettings          (void) { return _cameraInfoSettings; }
    HttpServerSettings*             httpServerSettings          (void) { return _httpServerSettings; }
    NTRIPSettings*                  ntripSettings               (void) { return _ntripSettings; }
    RosTopicSettings*               rosTopicSettings            (void) { return _rosTopicSettings; }
private:
#if defined(QGC_AIRMAP_ENABLED)
...
#endif
    VehicleInfoSettings*            _vehicleInfoSettings;
    CameraInfoSettings*             _cameraInfoSettings;
    HttpServerSettings*             _httpServerSettings;
    NTRIPSettings*                  _ntripSettings;
    RosTopicSettings*               _rosTopicSettings;
};
