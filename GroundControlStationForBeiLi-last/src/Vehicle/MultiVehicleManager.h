...
public:
    ...
    Q_PROPERTY(QmlObjectListModel*  firstVehicles                   READ firstVehicles                                                  CONSTANT)
    Q_PROPERTY(QmlObjectListModel*  secondVehicles                  READ secondVehicles                                                 CONSTANT)
    Q_PROPERTY(QmlObjectListModel*  thirdVehicles                   READ thirdVehicles                                                  CONSTANT)
    Q_PROPERTY(QmlObjectListModel*  fourthVehicles                  READ fourthVehicles                                                 CONSTANT)
    ...
    QmlObjectListModel* firstVehicles(void) { return &_firstVehicles; }
    QmlObjectListModel* secondVehicles(void) { return &_secondVehicles; }
    QmlObjectListModel* thirdVehicles(void) { return &_thirdVehicles; }
    QmlObjectListModel* fourthVehicles(void) { return &_fourthVehicles; }
...
private:
    ...
    void _insertVehicleForGroup(Vehicle *vehicle);
    void _removeVehicleForGroup(Vehicle *vehicle);
    ...
    QmlObjectListModel  _firstVehicles;
    QmlObjectListModel  _secondVehicles;
    QmlObjectListModel  _thirdVehicles;
    QmlObjectListModel  _fourthVehicles;
    ...
    QStringList _colors;
    QStringList _uavIcons;
    QStringList _carIcons;
};
