...
public:
    ...
    Q_PROPERTY(QStringList          flightModesZh               READ flightModesZh                                                  NOTIFY flightModesChanged)
    Q_PROPERTY(QStringList          flightModesForSimple        READ flightModesForSimple                                           NOTIFY flightModesChanged)
    Q_PROPERTY(QStringList          flightModesZhForSimple      READ flightModesZhForSimple                                         NOTIFY flightModesChanged)
    ...
    Q_PROPERTY(QString              flightModeZh                READ flightModeZh               WRITE setFlightMode                 NOTIFY flightModeChanged)
    ...
    Q_PROPERTY(QString              vehicleImageOpaque          READ vehicleImageOpaque                                             NOTIFY vehicleImageOpaqueChanged)
    ...
    Q_PROPERTY(QString              vehiclePathColor            READ vehiclePathColor                                               NOTIFY vehiclePathColorChanged)
    ...
    Q_PROPERTY(Fact* distanceToNext     READ distanceToNext     CONSTANT)
    Q_PROPERTY(Fact* headingToHome      READ headingToHome      CONSTANT)
    Q_PROPERTY(Fact* distanceToGCS      READ distanceToGCS      CONSTANT)
    Q_PROPERTY(Fact* hobbs              READ hobbs              CONSTANT)
    Q_PROPERTY(Fact* throttlePct        READ throttlePct        CONSTANT)
    Q_PROPERTY(Fact* flightTimeFact     READ flightTimeFact     CONSTANT)
    Q_PROPERTY(Fact* soundHeadingFact   READ soundHeadingFact     CONSTANT)
    ...
    Q_PROPERTY(bool     isCar                       READ isCar    WRITE setCar      NOTIFY isCarChanged)
    Q_PROPERTY(QList<QGeoCoordinate> missionCoordinate       READ missionCoordinate          CONSTANT)
    ...
    Q_INVOKABLE void missionModeChangeAltitude(double altitudeChange);
    ...
    Q_INVOKABLE int currentMissionSequence(void);

    Q_INVOKABLE int missionCount(void);

    Q_INVOKABLE void setSpeed(int speed);

    Q_INVOKABLE void setLoiterRadius(int radius);

    Q_INVOKABLE int loiterRadius(void);
    ...
    Q_INVOKABLE void goHome(); // 回机槽

    Q_INVOKABLE void beiliGimbalMountControl(float pitch);

    Q_INVOKABLE void setCameraStatus(int status);

    QList<QGeoCoordinate> missionCoordinate();
    ...
    QStringList flightModesForSimple        ();
    QStringList flightModesZh               ();
    QStringList flightModesZhForSimple      ();
    QStringList extraJoystickFlightModes    ();
    QString flightMode                      () const;
    QString flightModeZh                    () const;
    ...
    Fact* distanceToNext                    () { return &_distanceToNextFact; }
    Fact* headingToHome                     () { return &_headingToHomeFact; }
    Fact* distanceToGCS                     () { return &_distanceToGCSFact; }
    Fact* hobbs                             () { return &_hobbsFact; }
    Fact* throttlePct                       () { return &_throttlePctFact; }
    Fact* flightTimeFact                    () { return &_flightTimeFact; }
    Fact* soundHeadingFact                  () { return &_soundHeadingFact; }
    ...
    QString vehiclePathColor    () const;
    QString activeColor         () const { return _activeColor; }
    void setActiveColor(QString activeColor) { _activeColor = activeColor; }
    QString color               () const { return _color; }
    void setColor               (QString color) { _color = color; }
    void setPlaneImage          (QString image) { _planeImage = image; }
    void setCarImage            (QString image) { _carImage = image; }
    void setActivePlaneImage    (QString image) { _activePlaneImage = image; }
    void setActiveCarImage      (QString image) { _activeCarImage = image; }
    void updateVehicleImageOpaque() { _updateVehicleImageOpaque(); }
...
signals:
    ...
    void isCarChanged                   ();
    void vehicleImageOpaqueChanged      ();
    void vehiclePathColorChanged        ();
private slots:
    ...
    void _updateVehicleImageOpaque          ();
private:
...
//    void _handleGps2RawInt              (mavlink_message_t& message);
    ...
    QString _vehicleImageOpaque;
    QString _planeImage;
    QString _carImage;
    QString _activePlaneImage;
    QString _activeCarImage;
    QString _vehiclePathColor;
    QString _color;
    ...
    Fact _distanceToNextWPFact; // 与下一个航点的距离
    Fact _distanceToNextFact; // 与下一个目标的距离
    Fact _headingToHomeFact;
    Fact _distanceToGCSFact;
    Fact _hobbsFact;
    Fact _throttlePctFact;
    Fact _soundHeadingFact;
    ...
    static const char* _distanceToNextFactName;
    static const char* _headingToHomeFactName;
    static const char* _distanceToGCSFactName;
    static const char* _hobbsFactName;
    static const char* _throttlePctFactName;
    static const char* _soundHeadingFactName;
