...
public:
    ...
    virtual QStringList flightModes(Vehicle* /*vehicle*/, bool /*isSimple*/) { return QStringList(); }

    virtual QStringList flightModesZh(Vehicle* /*vehicle*/) { return QStringList(); }

    virtual QStringList flightModesZh(Vehicle* /*vehicle*/, bool /*isSimple*/) { return QStringList(); }
    ...
    virtual QString flightModeZh(uint8_t base_mode, uint32_t custom_mode) const;
