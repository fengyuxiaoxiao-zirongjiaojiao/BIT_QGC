...
QString FirmwarePlugin::flightModeZh(uint8_t base_mode, uint32_t custom_mode) const
{
    QString flightMode;
    ...
    static const struct Bit2Name rgBit2Name[] = {
    { MAV_MODE_FLAG_MANUAL_INPUT_ENABLED,   "手动" },
    { MAV_MODE_FLAG_STABILIZE_ENABLED,      "增稳" },
    { MAV_MODE_FLAG_GUIDED_ENABLED,         "引导" },
    { MAV_MODE_FLAG_AUTO_ENABLED,           "自动" },
    { MAV_MODE_FLAG_TEST_ENABLED,           "测试" },
};
