...
PX4FirmwarePlugin::PX4FirmwarePlugin()
    ...
    , _manualFlightModeZh     (QStringLiteral("手动"))
    , _acroFlightModeZh       (QStringLiteral("特技"))
    , _stabilizedFlightModeZh (QStringLiteral("增稳"))
    , _rattitudeFlightModeZh  (QStringLiteral("姿态"))
    , _altCtlFlightModeZh     (QStringLiteral("定高"))
    , _posCtlFlightModeZh     (QStringLiteral("位置"))
    , _offboardFlightModeZh   (QStringLiteral("场外"))
    , _readyFlightModeZh      (QStringLiteral("准备"))
    , _takeoffFlightModeZh    (QStringLiteral("起飞"))
    , _holdFlightModeZh       (QStringLiteral("悬停"))
    , _missionFlightModeZh    (QStringLiteral("任务"))
    , _rtlFlightModeZh        (QStringLiteral("返航"))
    , _landingFlightModeZh    (QStringLiteral("降落"))
    , _preclandFlightModeZh   (QStringLiteral("精准降落"))
    , _rtgsFlightModeZh       (QStringLiteral("回到基站"))
    , _followMeFlightModeZh   (QStringLiteral("跟随"))
    , _simpleFlightModeZh     (QStringLiteral("简单"))
    , _orbitFlightModeZh      (QStringLiteral("轨道"))
{
    ...
    struct Modes2Name {
        ...
        bool        isSimple;   /// true: 用于普通用户显示的模式
    };

    static const struct Modes2Name rgModes2Name[] = {
        //main_mode                         sub_mode                                canBeSet  FW      MC  isSimple
        { PX4_CUSTOM_MAIN_MODE_MANUAL,      0,                                      true,   true,   true,  false },
        { PX4_CUSTOM_MAIN_MODE_STABILIZED,  0,                                      true,   true,   true,  false },
        { PX4_CUSTOM_MAIN_MODE_ACRO,        0,                                      true,   true,   true,  false },
        { PX4_CUSTOM_MAIN_MODE_RATTITUDE,   0,                                      true,   true,   true,  true },
        { PX4_CUSTOM_MAIN_MODE_ALTCTL,      0,                                      true,   true,   true,  true },
        { PX4_CUSTOM_MAIN_MODE_OFFBOARD,    0,                                      true,   false,  true,  true },
        { PX4_CUSTOM_MAIN_MODE_SIMPLE,      0,                                      false,  false,  true,  true },
        { PX4_CUSTOM_MAIN_MODE_POSCTL,      PX4_CUSTOM_SUB_MODE_POSCTL_POSCTL,      true,   true,   true,  false },
        { PX4_CUSTOM_MAIN_MODE_POSCTL,      PX4_CUSTOM_SUB_MODE_POSCTL_ORBIT,       false,  false,  false, false },
        { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_LOITER,        true,   true,   true,  true },
        { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_MISSION,       true,   true,   true,  true },
        { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_RTL,           true,   true,   true,  true },
        { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_FOLLOW_TARGET, true,   false,  true,  true },
        { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_LAND,          false,  true,   true,  false },
        { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_PRECLAND,      false,  false,  true,  false },
        { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_READY,         false,  true,   true,  false },
        { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_RTGS,          false,  true,   true,  false },
        { PX4_CUSTOM_MAIN_MODE_AUTO,        PX4_CUSTOM_SUB_MODE_AUTO_TAKEOFF,       false,  true,   true,  false },
    };
    ...
    const QString* rgModeNamesZh[] = {
        &_manualFlightModeZh,
        &_stabilizedFlightModeZh,
        &_acroFlightModeZh,
        &_rattitudeFlightModeZh,
        &_altCtlFlightModeZh,
        &_offboardFlightModeZh,
        &_simpleFlightModeZh,
        &_posCtlFlightModeZh,
        &_orbitFlightModeZh,
        &_holdFlightModeZh,
        &_missionFlightModeZh,
        &_rtlFlightModeZh,
        &_followMeFlightModeZh,
        &_landingFlightModeZh,
        &_preclandFlightModeZh,
        &_readyFlightModeZh,
        &_rtgsFlightModeZh,
        &_takeoffFlightModeZh,
    };
...
QStringList PX4FirmwarePlugin::flightModesZh(Vehicle* vehicle)
{
...
QStringList PX4FirmwarePlugin::flightModesZh(Vehicle *vehicle, bool isSimple)
{
    QStringList flightModes;
    ...
    foreach (const FlightModeInfo_t& info, _flightModeInfoList) {
        if (info.canBeSet) {
            ...
            if (fw || mc || other) {
                if (isSimple) {
                    if (info.isSimple) flightModes += *info.nameZh;
                } else {
                    flightModes += *info.nameZh;
                }
            }
...
QString PX4FirmwarePlugin::flightModeZh(uint8_t base_mode, uint32_t custom_mode) const
{
...
QStringList PX4FirmwarePlugin::flightModes(Vehicle *vehicle, bool isSimple)
{
    QStringList flightModes;
    ...
    foreach (const FlightModeInfo_t& info, _flightModeInfoList) {
        if (info.canBeSet) {
            ...
            if (fw || mc || other) {
                if (isSimple) {
                    if (info.isSimple) flightModes += *info.name;
                } else {
                    flightModes += *info.name;
                }
            }
...
bool PX4FirmwarePlugin::setFlightMode(const QString& flightMode, uint8_t* base_mode, uint32_t* custom_mode)
{
    ...
    *custom_mode = 0;
    ...
    bool found = false;
    foreach (const FlightModeInfo_t& info, _flightModeInfoList) {
        if (flightMode.compare(info.name, Qt::CaseInsensitive) == 0 || flightMode.compare(info.nameZh, Qt::CaseInsensitive) == 0) {
            union px4_custom_mode px4_mode;
