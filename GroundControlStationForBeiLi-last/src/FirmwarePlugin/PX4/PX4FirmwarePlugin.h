...
public:
    ...
    QStringList         flightModesZh                   (Vehicle* vehicle) override;
    QStringList         flightModesZh                   (Vehicle* vehicle, bool isSimple) override;
    QString             flightModeZh                    (uint8_t base_mode, uint32_t custom_mode) const override;
    QStringList         flightModes                     (Vehicle* vehicle) override;
    QStringList         flightModes                     (Vehicle* vehicle, bool isSimple) override;
...
protected:
    typedef struct {
        ...
        const QString*  nameZh;     ///< Name for flight mode
    ...
    QString _manualFlightModeZh;
    QString _acroFlightModeZh;
    QString _stabilizedFlightModeZh;
    QString _rattitudeFlightModeZh;
    QString _altCtlFlightModeZh;
    QString _posCtlFlightModeZh;
    QString _offboardFlightModeZh;
    QString _readyFlightModeZh;
    QString _takeoffFlightModeZh;
    QString _holdFlightModeZh;
    QString _missionFlightModeZh;
    QString _rtlFlightModeZh;
    QString _landingFlightModeZh;
    QString _preclandFlightModeZh;
    QString _rtgsFlightModeZh;
    QString _followMeFlightModeZh;
    QString _simpleFlightModeZh;
    QString _orbitFlightModeZh;
