...
APMSubMode::APMSubMode(uint32_t mode, bool settable, bool isSimple) :
    APMCustomMode(mode, settable, isSimple)
{
    ...
    setEnumToStringZhMapping({
        ...
        {ALT_HOLD,  QStringLiteral("定深")},
        {AUTO, QStringLiteral("自动")},
        {GUIDED, QStringLiteral("引导")},
        {CIRCLE, QStringLiteral("绕圈")},
        {SURFACE, QStringLiteral("水面")},
        {POSHOLD, QStringLiteral("定点")},
        {MOTORDETECTION, QStringLiteral("电机检测")},
    });
}
    ...
    _infoFactGroup(this)
{
    setSupportedModes({
        ...
        APMSubMode(APMSubMode::MANUAL ,         true,       false),
        APMSubMode(APMSubMode::STABILIZE ,      true,       false),
        APMSubMode(APMSubMode::ACRO ,           true,       false),
        APMSubMode(APMSubMode::ALT_HOLD  ,      true,       true),
        APMSubMode(APMSubMode::AUTO ,           true,       true),
        APMSubMode(APMSubMode::GUIDED ,         true,       false),
        APMSubMode(APMSubMode::CIRCLE ,         true,       false),
        APMSubMode(APMSubMode::SURFACE ,        false,      false),
        APMSubMode(APMSubMode::POSHOLD ,        true,       true),
        APMSubMode(APMSubMode::MOTORDETECTION,  false,      false),
    });
