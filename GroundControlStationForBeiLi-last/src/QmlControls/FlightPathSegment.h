...
public:
    ...
    Q_PROPERTY(bool             dottedLine              READ dottedLine                 WRITE setDottedLine     NOTIFY dottedLineChanged)
    ...
    bool                dottedLine          (void) const { return _dottedLine; }
...
public slots:
    ...
    void setDottedLine      (bool dottedLine);
signals:
    ...
    void dottedLineChanged          (bool dottedLine);
