...
public:
    ...
    Q_PROPERTY(HttpAPIManager* httpAPIManager   READ httpAPIManager             CONSTANT)
    Q_PROPERTY(KmlManager*     kmlManager       READ kmlManager                 CONSTANT)
    Q_PROPERTY(ControlCenterManager*     controlCenterManager       READ controlCenterManager                 CONSTANT)
    Q_PROPERTY(WebMsgManager*            webMsgManager              READ webMsgManager                 CONSTANT)
    Q_PROPERTY(RvizManager*              rvizManager                READ rvizManager                 CONSTANT)
    ...
    Q_INVOKABLE bool defFlytouav(void);
    // Property accesors
    ...
    HttpAPIManager*         httpAPIManager      () { return _httpAPIManager; }
    KmlManager*             kmlManager          () { return _kmlManager; }
    ControlCenterManager*   controlCenterManager() { return _controlCenterManager; }
    WebMsgManager*          webMsgManager       () { return _webMsgManager; }
    RvizManager*            rvizManager         () { return _rvizManager; }
...
#endif
    HttpAPIManager*         _httpAPIManager         = nullptr;
    KmlManager*             _kmlManager             = nullptr;
    ControlCenterManager*   _controlCenterManager   = nullptr;
    WebMsgManager*          _webMsgManager          = nullptr;
    RvizManager*            _rvizManager            = nullptr;
