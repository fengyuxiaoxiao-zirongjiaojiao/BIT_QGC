...
#include "ControlCenterManager/ControlCenterManager.h"
#include "WebMsgManager/WebMsgManager.h"
#include "NTRIP/NTRIP.h"
#include "RvizManager/RvizManager.h"
#include "RosTopicManager/RosTopicManager.h"
...
#endif
    _httpAPIManager         = new HttpAPIManager            (app, this);
    _kmlManager             = new KmlManager                (app, this);
    _controlCenterManager   = new ControlCenterManager      (app, this);
    _webMsgManager          = new WebMsgManager             (app, this);
    _ntrip                  = new NTRIP                     (app, this);
    _rvizManager            = new RvizManager               (app, this);
    _rosTopicManager        = new RosTopicManager           (app, this);
}

void QGCToolbox::shutdown()
{
    if (_multiVehicleManager) _multiVehicleManager->shutdown();
    if (_rvizManager) _rvizManager->shutdown();
}
...
#endif
    _httpAPIManager->setToolbox(this);
    _kmlManager->setToolbox(this);
    _controlCenterManager->setToolbox(this);
    _webMsgManager->setToolbox(this);
    _ntrip->setToolbox(this);
    _rvizManager->setToolbox(this);
    _rosTopicManager->setToolbox(this);
}
