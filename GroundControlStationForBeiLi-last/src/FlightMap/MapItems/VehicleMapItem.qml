...
MapQuickItem {
    ...
    sourceItem: Item {
        ...
        opacity:    _adsbVehicle || vehicle === _activeVehicle ? 1.0 : 0.8
        ...
        QGCMapLabel {
            ...
            font.pointSize:             12//_adsbVehicle ? ScreenTools.defaultFontPointSize : ScreenTools.smallFontPointSize
            ...
            property string vehicleLabelText: visible ?
                                                  (_adsbVehicle ?
                                                       ...
                                                       (_multiVehicle ? (vehicle.isCar ? qsTr("车子 %1").arg(vehicle.id) : qsTr("飞机 %1").arg(vehicle.id)) : "")) :
                                                  ""
