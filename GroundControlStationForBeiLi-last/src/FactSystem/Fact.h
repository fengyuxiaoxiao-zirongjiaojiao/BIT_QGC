...
public:
    ...
    Q_PROPERTY(bool         typeIsFloat             READ typeIsFloat                                        CONSTANT)
    Q_PROPERTY(bool         typeIsDouble            READ typeIsDouble                                       CONSTANT)
    Q_PROPERTY(bool         typeIsElapsedTimeInSeconds            READ typeIsElapsedTimeInSeconds           CONSTANT)
    ...
    Q_PROPERTY(QString      floatStringValue        READ floatStringValue                                   NOTIFY rawValueChanged)
    ...
    bool            typeIsFloat             (void) const { return type() == FactMetaData::valueTypeFloat; }
    bool            typeIsDouble            (void) const { return type() == FactMetaData::valueTypeDouble; }
    bool            typeIsElapsedTimeInSeconds(void) const { return type() == FactMetaData::valueTypeElapsedTimeInSeconds; }
    bool            hasControl              (void) const;
    bool            readOnly                (void) const;
    bool            writeOnly               (void) const;
    bool            volatileValue           (void) const;
    QString         floatStringValue        (void) const { return QString::number(_rawValue.toDouble(), 'f', 1); }
