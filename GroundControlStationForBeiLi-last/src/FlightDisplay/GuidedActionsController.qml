...
Item {
    ...
    readonly property string toCarTitle:                    qsTr("To Car")
    readonly property string toPlanTitle:                   qsTr("To Plan")
    readonly property string gotoNestTitle:                 qsTr("Go To Nest")
...
//    readonly property string pauseMessage:                      qsTr("Pause the vehicle at it's current position, adjusting altitude up or down as needed.")
    ...
    readonly property string carTransitionToPlanMessage:        qsTr("Transition car to plan.")
    readonly property string planTransitionToCarMessage:        qsTr("Transition plan to car.")
    readonly property string gotoNestMessage:                   qsTr("Move the vehicle back to machine the nest.")
    ...
    readonly property int actionToCar:                      25
    readonly property int actionToPlan:                     26
    readonly property int actionGotoNest:                   27
    ...
    property bool showToCar:            _guidedActionsEnabled && !_vehicleFlying && !_activeVehicle.isCar
    property bool showToPlan:           _guidedActionsEnabled && _activeVehicle.isCar
    property bool showGotoNest:         _guidedActionsEnabled && _vehicleFlying
    ...
    function confirmAction(actionCode, actionData, mapIndicator) {
        ...
        case actionActionList:
            ...
            return
        case actionToCar:
            confirmDialog.title = toCarTitle
            confirmDialog.message = planTransitionToCarMessage
            confirmDialog.hideTrigger = Qt.binding(function() { return !showToCar })
            break;
        case actionToPlan:
            confirmDialog.title = toPlanTitle
            confirmDialog.message = carTransitionToPlanMessage
            confirmDialog.hideTrigger = Qt.binding(function() { return !showToPlan })
            break;
        case actionGotoNest:
            confirmDialog.title = gotoNestTitle
            confirmDialog.message = gotoNestMessage
            confirmDialog.hideTrigger = Qt.binding(function() { return !showGotoNest })
            break;
        default:
    ...
    function executeAction(actionCode, actionData, actionAltitudeChange, optionChecked) {
        ...
        case actionROI:
            ...
            break
        case actionToCar:
            _activeVehicle.isCar = true
            break;
        case actionToPlan:
            _activeVehicle.isCar = false
            break;
        case actionGotoNest:
